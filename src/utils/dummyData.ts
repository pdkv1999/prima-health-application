...
export const dummyData = {
  ...
  stage1: {
    ...
    developmentalMilestones: "Early milestones were achieved ahead of typical expectations with walking at 10 months, first meaningful words at 11 months ('mama', 'dada', 'ball'), and two-word combinations by 15 months. Short sentences emerged by 18 months with vocabulary development proceeding rapidly. Gross motor skills developed appropriately with running, jumping, and climbing abilities emerging within expected timeframes. Fine motor development showed some variability with adequate pincer grasp by 12 months but ongoing difficulties with pencil grip and manipulative tasks requiring precision. Toilet training was initiated at 2.5 years and achieved for daytime continence by 3 years, with occasional nighttime accidents continuing until age 4.5 years. No regression in developmental skills has been noted. Social-emotional milestones showed some delays with difficulty separating from parents extending beyond typical timeframes, and challenges with peer interaction becoming more apparent during preschool years. Language development continued to be an area of strength with complex sentence structures and extensive vocabulary evident by age 4.",
