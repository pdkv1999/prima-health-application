...
export default function Report() {
  ...
  const reportSections = useMemo(() => {
    ...
    const sections = [
      {
        title: "Patient Information & Referral",
        content:
          htmlHighlighted.split("<h2>")[0] +
          (htmlHighlighted.split("<h2>")[1]
            ? "<h2>" + htmlHighlighted.split("<h2>")[1].split("<h2>")[0]
            : ""),
      },
      {
        title: "Developmental & Medical History",
        content: htmlHighlighted.split("<h2>")[2]
          ? "<h2>" + htmlHighlighted.split("<h2>")[2].split("<h2>")[0]
          : "",
      },
      {
        title: "Clinical Assessment & Observations",
        content: htmlHighlighted.split("<h2>")[3]
          ? "<h2>" + htmlHighlighted.split("<h2>")[3].split("<h2>")[0]
          : "",
      },
      {
        title: "Diagnosis & Recommendations",
        content: htmlHighlighted
          .split("<h2>")
          .slice(4)
  ...
  const previewReport = () => {
    ...
    w.document.write(`<html><head><title>Report Preview</title>
      <style>
        ...
        .autofill-highlight { background: transparent !important; padding: 0 !important; }
      ...
      <div className="max-w-5xl mx-auto p-6 space-y-8">
        ...
        <div className="text-center">
          <h1 className="text-3xl font-light tracking-tight text-slate-800 mb-2">
            Final Report – Under 12s
          </h1>
          <p className="text-slate-600 font-light">
            PrimaHealth ADHD Assessment (PH25)
          </p>
        </div>
        ...
        {/* Report Content with Left/Right Buttons */}
              ...
              {emailSending ? (
                ...
                <div className="text-sm space-y-2">
                  ...
                  <p className="text-muted-foreground text-xs mt-2">
                    In production: Secure PDF attachment, delivery confirmation,
                    audit trail
                  </p>
                </div>
              )}
              ...
              <Button
                onClick={async () => {
                  ...
                  await sendEncryptedEmail(
                    cleanHtml,
                    meta.gpName || "gp@example.com"
                  );
                  setEmailSending(false);
                  toast({
                    title: "Email Sent",
                    description:
                      "Encrypted report sent successfully to all recipients.",
                  });
                  setOpen(false);
                }}
